...
- Name: landing_page.spec.js >> Landing page assets are deployed >> CSS stylesheet returns 200
- Location: tests/playwright/landing_page.spec.js:14:3
...
Call log:
  - → GET https://maximumtrainer.github.io/MaximumTrainer_Redux/css/style.css
