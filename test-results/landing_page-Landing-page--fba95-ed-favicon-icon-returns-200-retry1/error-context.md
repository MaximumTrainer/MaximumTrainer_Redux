...
- Name: landing_page.spec.js >> Landing page assets are deployed >> favicon / icon returns 200
- Location: tests/playwright/landing_page.spec.js:19:3

# Error details

```
Error: apiRequestContext.get: getaddrinfo EAI_AGAIN maximumtrainer.github.io
Call log:
  - → GET https://maximumtrainer.github.io/MaximumTrainer_Redux/assets/images/main_icon.png
