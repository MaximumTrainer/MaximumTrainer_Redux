...
- Name: landing_page.spec.js >> Landing page assets are deployed >> index.html returns 200
- Location: tests/playwright/landing_page.spec.js:9:3
...
Call log:
  - → GET https://maximumtrainer.github.io/MaximumTrainer_Redux/
